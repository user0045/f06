...
const PlayerAd1: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    if (container && !adLoaded) {
      ...
      script.onload = () => {
        console.log('Player Ad 1 loaded successfully');
        setAdLoaded(true);
      };

      script.onerror = () => {
        console.error('Failed to load Player Ad 1');
      };
  ...
  return (
    <div
      ref={containerRef}
      className="w-full bg-black/20 border border-gray-600/30 rounded-lg p-4 text-center"
      style={{ 
        minHeight: '140px', 
        width: '100%',
        overflow: 'visible',
  ...
  React.useEffect(() => {
    ...
    if (container && !adLoaded) {
      const timer = setTimeout(() => {
        ...
        // Set to global scope temporarily
        ...
        container.appendChild(script);
      }, 500); // Delay to prevent conflicts
  ...
  React.useEffect(() => {
    ...
    if (container && !adLoaded) {
      const timer = setTimeout(() => {
        ...
        container.appendChild(script);
      }, 1500); // Longest delay for this ad
      ...
      <div className="pt-20">
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="space-y-8">
            ...
            {/* First Advertisement Section - Full Width Container */}
            <div className="w-full" id="player-ads-section-1">
